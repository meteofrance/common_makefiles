...
refresh_common_makefiles: ## Refresh common makefiles from repository
	...
	cd .refresh_makefiles.tmp && $(_GIT_CLONE_DEPTH_1) $(COMMON_MAKEFILES_GIT_URL) && cd common_makefiles && $(_GIT_CHECKOUT_BRANCH) && cd .. && rm -Rf ../.common_makefiles && mv common_makefiles/dist ../.common_makefiles
