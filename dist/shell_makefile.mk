...
$(ROOT_TOOLS)/shellcheck:
	...
	@$(HEADER2) "shellcheck installed"

_remove_devenv::
	rm -Rf $(ROOT_TOOLS)/shellcheck

.PHONY: lint_shellcheck
lint_shellcheck: ## Lint the code with shellcheck
	@$(LINTER) shellcheck "$(_SHELLCHECK_BIN)" "$(SHELLCHECK_FILES)" "$(_SHELLCHECK_BIN) --help" "$(SHELLCHECK_ARGS)"

_lint:: lint_shellcheck
